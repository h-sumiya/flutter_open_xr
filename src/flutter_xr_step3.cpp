...
class FlutterXrStep3App {
   public:
    ...
    void Run() {
        std::cout << "Step3 integration sample started.\n";
   ...
   private:
    void CreateInstance() {
        ...
        std::strncpy(createInfo.applicationInfo.applicationName, "flutter_xr_step3",
    ...
    void InitializeFlutterEngine() {
        ...
        const char* commandLineArgs[] = {"flutter_xr_step3", "--enable-impeller=false"};
